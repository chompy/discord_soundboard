...
var (
	errMissingBotToken   = errors.New("missing discord bot token")
	errMissingAuthConfig = errors.New("missing discord auth client id and/or client secret")
	...
	errDatabaseOpen      = errors.New("unable to connect to database")
